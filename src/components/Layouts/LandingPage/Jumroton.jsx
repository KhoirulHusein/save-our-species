...
function Jumroton() {
  ...
  return (
    <div className="h-screen mt-[108px] relative w-full">
      ...
      />
      <div className="absolute w-[959px] backdrop-blur-sm h-[234px] flex flex-col gap-[43px] xs:gap-[10px] inset-[0] items-center justify-center m-auto p-[13px] rounded-[20px] z-10 sm:w-[90%] md:w-[80%] lg:w-[90%]" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
        <Text
