  ...
  return (
    <div className="h-[699px] md:h-[741px] mt-[181px] md:px-0 relative w-full xs:p-0 xs:justify-center xs:flex sm:p-0 sm:justify-center sm:flex md:flex md:justify-center">
      <div className="absolute h-[539px] inset-x-[0] mx-auto top-[0] w-full sm:h-[700px]">
        ...
        />
        <div className="absolute xl:w-[40%] bg-black-900_4c backdrop-blur-sm bottom-[0] flex flex-col items-start justify-end p-[35px] sm:px-5 right-[5%] rounded-[20px] xs:justify-center xs:right-0 xs:mx-5 xs:p-[20px] xs:bottom-[23%] sm:justify-center sm:right-0 sm:bottom-[20%] sm:mx-5 sm:w-auto md:right-0 md:w-[50%] md:justify-center md:mx-5 lg:w-[50%] lg:right-[3%] lg:justify-center lg:mx-5" data-aos="zoom-in-left" data-aos-delay="200">
          <Text
          ...
          >
            Temukan bagaimana Anda dapat berkontribusi untuk melindungi dan melestarikan
            keberlanjutan kehidupan hewan langka bersama kami.
          </Text>
          <Text
      ...
      <div className="absolute bg-gray-900_01 bottom-[0] flex sm:flex-col flex-row sm:gap-5 items-center justify-start p-[39px] sm:px-5 xl:right-[5%] rounded-[20px] w-[35%] xs:bottom-[-5%] xs:w-[70%] xs:p-[20px] sm:w-[60%] sm:bottom-[-15%] md:w-fit md:p-7 md:gap-0 md:right-auto lg:w-[50%] lg:p-7 lg:right-[6%] lg:gap-0 xl:w-[40%]" data-aos="zoom-in" data-aos-delay="300">
        <Text
        ...
        <Button
          className="common-pointer cursor-pointer font-medium min-w-[178px] sm:ml-[0] ml-[47px] sm:mt-0 my-0.5 text-center text-lg xs:text-base tracking-[-0.18px] lg:ml-auto xl:ml-auto xl:gap-0 xl:min-w-[155px]"
