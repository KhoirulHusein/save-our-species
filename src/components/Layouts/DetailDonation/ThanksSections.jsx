...
const ThanksSections = () => {
  ...
  return (
    <div className="w-[500px] h-fit bg-light_green-800 rounded-[20px] p-10 items-center lg:w-[450px] lg:h-fit md:w-full md:h-fit sm:w-fit sm:h-fit xs:w-fit xs:h-fit">
      ...
      >
        Dukungan anda sangat membantu hewan yang terancam punah
      </Text>
      <div className="py-4">
        <Img
          className="justify-center mx-auto py-5 object-cover rounded-[20px] w-2/5"
          src="images/thanksIlustration.png"
