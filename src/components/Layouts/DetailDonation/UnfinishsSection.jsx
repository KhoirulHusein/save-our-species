...
const UnfinishsSection = () => {
  ...
  return (
    <div className="w-[500px] h-fit bg-light_green-800 rounded-[20px] p-10 items-center lg:w-[450px] lg:h-fit md:w-full md:h-fit sm:w-fit sm:h-fit xs:w-fit xs:h-fit">
      ...
      <div className="py-4">
        <Img
          className="justify-center mx-auto py-5 object-cover rounded-[20px] w-9/12"
          src="images/pending.png"
          alt="Pending Ilustration"
        />
        <Text
...
export default UnfinishsSection;
